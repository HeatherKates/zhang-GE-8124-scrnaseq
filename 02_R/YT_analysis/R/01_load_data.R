...
samples <- paste0(DATASET, c("_Vehicle_1", "_Vehicle_3", "_PZ15227_1", "_PZ15227_2", "_PZ15227_3")) # "_Vehicle_2" removed for YT
age = "Young" # "Young"
tissue = "Tumor" # "Tumor"
...
message(paste("=== PROTAC scRNA-seq Analysis:",DATASET,"Group (",age,tissue,") ==="))
...
sample_metadata <- data.frame(
  sample_id = samples,
  treatment = c("Vehicle", "Vehicle", "PZ15227", "PZ15227", "PZ15227"),
  replicate = c("Rep1", "Rep3", "Rep1", "Rep2", "Rep3"),  # Note: Rep2 missing for Vehicle
  age = age,
  tissue = tissue,
  condition = c("YT_Vehicle", "YT_Vehicle", "YT_PZ15227", "YT_PZ15227", "YT_PZ15227"),
